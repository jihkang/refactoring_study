...
var renderDiv = function renderDiv(data) {
  div.innerHTML = data;
};
var refreshSite = function refreshSite() {
  var respond = Ajax(NEWS_URL);
  renderDiv("\n        <ul>\n        ".concat(respond.map(function (item) {
    return "\n                <li>\n                    <a href=#".concat(item.id, ">").concat(item.title, " ").concat(item.comments_count, "</a>\n                </li>");
  }).join('\n'), "\n        </ul>"));
};
window.addEventListener("hashchange", function (e) {
  ...
  var respond = Ajax(CONTENT_URL.replace('@id', id));
  renderDiv("\n        <h1>\n            ".concat(respond.title, "\n        </h1>\n    "));
});
